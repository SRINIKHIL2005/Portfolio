      ...
      <div className="container relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            >
              Full Stack Developer & AI Specialist with expertise in building secure, scalable web solutions and integrating artificial intelligence.
            </motion.p>
            <motion.div 
        ...
        <div className="border-t border-border/50 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <motion.p 
            className="text-muted-foreground text-xs mt-2 md:mt-0"
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
            Made with <span className="text-tech-red">♥</span> using React & Tailwind
          </motion.p>
        </div>
      </div>
    </footer>
